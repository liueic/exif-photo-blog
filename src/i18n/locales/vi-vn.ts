...
export const TEXT: I18N = {
  ...
  admin: {
    ...
    visibilityDefaultNote: 'Hiển thị ở mọi nơi',
    visibilityExclude: 'Ẩn khỏi nguồn cấp',
    visibilityExcludeNote: 'Loại trừ khỏi trang chủ, rss.xml, v.v.',
    visibilityPrivate: 'Riêng tư',
    visibilityPrivateNote: 'Chỉ quản trị viên xem được',
    selectPhotosBelow: 'Chọn ảnh bên dưới',
    selectPhotosBelowShort: 'Chọn',
    selecting: 'Đang chọn ...',
    selectingShort: 'Đang chọn',
    photosSelected: 'Đã chọn {{quantity}}',
